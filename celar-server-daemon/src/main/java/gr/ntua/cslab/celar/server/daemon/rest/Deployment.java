...
public class Deployment {
    ...
    public DeploymentInfo getDeployment(@PathParam("id") int id) {
        return new DeploymentInfo(id, new Date().getTime()-10000l, new Date().getTime()+10000l, DeploymentStatus.ERROR);
    }
    ...
    public List<DeploymentInfo> searchDeployments(
        ...
        list.add(new DeploymentInfo(1, startTime, endTime, status));
        list.add(new DeploymentInfo(2, startTime, endTime, status));
        list.add(new DeploymentInfo(3, startTime, endTime, status));
        return list;
    }
}
