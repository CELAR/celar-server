...
ALTER TABLE DEPLOYMENT_STATE ADD CONSTRAINT fk_DEPLOYMENT_STATE_1 FOREIGN KEY (DEPLOYMENT_id) REFERENCES DEPLOYMENT (id) ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED;
CREATE INDEX DEPLOYMENT_idDEPLOYMENT_STATE ON DEPLOYMENT_STATE (DEPLOYMENT_id);
