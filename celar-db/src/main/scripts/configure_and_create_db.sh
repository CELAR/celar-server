...
-- Foreign keys --
ALTER TABLE "APPLICATION" ADD CONSTRAINT "fk_APPLICATION_1" FOREIGN KEY ("USER_id") REFERENCES "USER" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED;
...
psql -U celaruser -d celardb -a -f temp &>/dev/null
rm -f temp
